      ...
      <main className="mistral-main" style={{ flex: 1, display: "flex", flexDirection: "column" }}>
        <div className="max-w-mistral border-grid-x" style={{ flex: 1, display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "1.5rem" }}>
              <div>
                ...
                <h1 className="text-h1" style={{ marginBottom: "0.5rem" }}>
                  Claim Reference: {currentClaim.claim_reference}
                </h1>
                <p style={{ color: "var(--text-secondary)", fontSize: "0.95rem" }}>
                  {currentClaim.hospital_name} · Total Knee Arthroplasty (Left) · Incurred: ₹{Number(currentClaim.claim_amount || 0).toLocaleString("en-IN")}
                </p>
              </div>

              <div style={{ display: "flex", gap: "0.75rem", alignItems: "center" }}>
                <span className="mistral-badge badge-danger" style={{ fontSize: "0.85rem", padding: "0.4rem 0.8rem" }}>
                  <PixelAlert size={14} /> Repudiated by TPA
                </span>
                <span className="mistral-badge badge-ready" style={{ fontSize: "0.85rem", padding: "0.4rem 0.8rem" }}>
                  <PixelCheck size={14} /> 78-Mo Moratorium Shield
                </span>
              </div>
            </div>
          </section>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", borderBottom: "1px solid var(--border-primary)" }} className="divide-grid-x">
            ...
            <div className="mistral-cell" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                ...
                <h3 className="text-h3" style={{ marginBottom: "0.5rem" }}>Readiness Audit</h3>
                <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", lineHeight: 1.5 }}>
                  Deterministic verification across 6 mandatory document requirements. 5 satisfied, 1 gap identified (Indoor Case Papers).
                </p>
              </div>
              <div style={{ marginTop: "1.5rem" }}>
                <Link
                  ...
                  style={{ width: "100%" }}
                >
                  Inspect Checklist <PixelArrowRight size={14} />
                </Link>
              </div>
            </div>
            ...
            <div className="mistral-cell" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                ...
                <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", lineHeight: 1.5 }}>
                  Tripartite analysis decomposing the repudiation notice. Explains why Clause 4.2 invocation is invalid under IRDAI 2024 Chapter V.
                </p>
              </div>
              <div style={{ marginTop: "1.5rem" }}>
                <Link
                  ...
                  style={{ width: "100%" }}
                >
                  Decode Repudiation <PixelArrowRight size={14} />
                </Link>
              </div>
            </div>
            ...
            <div className="mistral-cell" style={{ display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
              <div>
                ...
                <p style={{ fontSize: "0.85rem", color: "var(--text-secondary)", lineHeight: 1.5 }}>
                  Six-part structured First-Level Grievance brief with explicit user review &amp; sign-off gatekeeper before PDF export.
                </p>
              </div>
              <div style={{ marginTop: "1.5rem" }}>
                <Link
                  ...
                  style={{ width: "100%" }}
                >
                  Review Appeal Brief <PixelArrowRight size={14} />
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="mistral-cell-header">
            <span className="text-eyebrow">Claim Dossier &amp; Grounding Evidence</span>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))" }} className="divide-grid-x">
            <div className="mistral-cell">
              <span className="text-eyebrow" style={{ display: "block", marginBottom: "0.25rem" }}>Policy Schedule</span>
            ...
            <div className="mistral-cell">
              <span className="text-eyebrow" style={{ display: "block", marginBottom: "0.25rem" }}>Clinical Particulars</span>
            ...
            <div className="mistral-cell">
              <span className="text-eyebrow" style={{ display: "block", marginBottom: "0.25rem" }}>Financial Particulars</span>
          ...
          <div className="border-t-grid mistral-banner-notice">
            <PixelAlert size={16} />
            <p>
              <strong>Regulatory Notice:</strong> Under the IRDAI Master Circular 2024 (Chapter V, Section 5.3), health claims cannot be contested for pre-existing conditions after 60 continuous months of coverage. ClaimSaathi equips policyholders with structured legal grounding for first-level grievances.
            </p>
          </div>
        </div>
      </main>
